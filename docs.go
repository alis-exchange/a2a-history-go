...
// package-level registration helpers such as [RegisterGRPC] and [RegisterHTTP].
// Callers that hold a concrete history service instance can also use its
// RegisterGRPC and RegisterHTTP methods directly.
//
