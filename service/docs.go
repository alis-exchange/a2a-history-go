...
//
// [ThreadService.RegisterGRPC] and [ThreadService.RegisterHTTP] mount the gRPC and JSON-RPC
// transports without requiring callers to import the generated protobuf package or jsonrpc
// subpackage directly.
//
